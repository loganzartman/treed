...
export const monkeypatchPcss = (three) => {
  let shader = three.ShaderChunk.shadowmap_pars_fragment;

  shader = shader.replace(
    "#ifdef USE_SHADOWMAP",
    "#ifdef USE_SHADOWMAP" + shaderPcss
  );

  shader = shader.replace(
    "#if defined( SHADOWMAP_TYPE_PCF )",
    shaderPcssGetShadow + "#if defined( SHADOWMAP_TYPE_PCF )"
  );
